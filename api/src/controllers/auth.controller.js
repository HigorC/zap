...
export const register = async (req, res, next) => {
    try {
        ...
        const access_token = await generateToken({ userId: newUser._id }, "1d", process.env.ACCES_TOKEN_SECRET)
...
export const login = async (req, res, next) => {
    try {
        ...
        const access_token = await generateToken({ userId: user._id }, "1d", process.env.ACCES_TOKEN_SECRET)
